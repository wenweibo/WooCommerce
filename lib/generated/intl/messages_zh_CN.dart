...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m10(message) => "错误： ${message}";
  ...
  static String m27(total) => "${total} 个商品";
  ...
  static String m31(length) => "我们找到了 ${length} 件商品";

  static String m32(week) => "第 ${week} 周";
