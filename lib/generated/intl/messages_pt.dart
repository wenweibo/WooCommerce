...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(currency) => "${currency} não é compatível";

  static String m6(day) => "${day} dias atrás";

  static String m7(total) => "~${total} km";

  static String m8(timeLeft) => "Ends in ${timeLeft}";

  static String m9(captcha) => "Digite ${captcha} para confirmar:";

  static String m10(message) => "Erro: ${message}";

  static String m11(time) => "Expirando em ${time}";

  static String m12(total) => ">${total} km";

  static String m13(hour) => "${hour} horas atrás";
  ...
  static String m15(size) => "Tamanho máximo do arquivo: ${size} MB";

  static String m16(minute) => "${minute} minutos atrás";

  static String m17(month) => "${month} meses atrás";

  static String m18(store) => "Mais de ${store}";

  static String m19(itemCount) => "${itemCount} itens";

  static String m20(price) => "Opções totais: ${price}";

  static String m21(total) => "Qtd: ${total}";

  static String m22(percent) => "Desconto ${percent} %";

  static String m23(second) => "${second} segundos atrás";
  ...
  static String m26(fieldName) => "O campo ${fieldName} é obrigatório";

  static String m27(total) => "${total} produtos";

  static String m28(date) => "Válido até ${date}";

  static String m29(message) => "Atenção: ${message}";
  ...
  static String m31(length) => "Encontramos ${length} produtos";

  static String m32(week) => "Semana ${week}";

  static String m33(year) => "${year} anos atrás";

  static String m34(total) => "Você atribuiu o pedido nº${total}";
