...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(day) => "${day} dana prije";

  static String m7(total) => "~${total} km";

  static String m8(timeLeft) => "Završava za ${timeLeft}";

  static String m10(message) => "Greška: ${message}";

  static String m11(time) => "Ističe za${time}";

  static String m12(total) => ">${total} km";

  static String m13(hour) => "${hour} sati prije";
  ...
  static String m15(size) => "Maksimalna veličina fajla: ${size} MB";

  static String m16(minute) => "${minute} minuta prije";

  static String m17(month) => "${month} mjeseca prije";

  static String m19(itemCount) => "${itemCount} proizvoda";

  static String m20(price) => "Ukupno opcija: ${price}";

  static String m21(total) => "Količina: ${total}";

  static String m22(percent) => "Rasprodaja ${percent}%";

  static String m23(second) => "${second} sekundi prije";

  static String m24(totalCartQuantity) =>
      "Korpa za kupovinu, ${totalCartQuantity} proizvoda";

  static String m25(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";

  static String m27(total) => "${total} proizvoda";

  static String m28(date) => "Validno do ${date}";

  static String m29(message) => "Upozorenje: ${message}";
  ...
  static String m31(length) => "Pronašli smo ${length} proizvoda";

  static String m32(week) => "Sedmica ${week}";

  static String m33(year) => "${year} godine prije";

  static String m34(total) => "Dodijeljeni ste narudžbi #${total}";
